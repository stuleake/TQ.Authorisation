...
namespace TQ.Geocoding.Service.Interface.Audit
{
    ...
    public interface IReadOnlyAddressAuditLogger 
    {
        ...
        /// <returns>a <see cref="Task"/> that contains the result of the async operation</returns>
        Task<IEnumerable<AddressSearchAuditLogDto>> GetAllBySearchTextAsync(string searchText);
        ...
        /// <returns>a <see cref="Task"/> that contains the result of the async operation</returns>
        Task<IEnumerable<AddressSearchAuditLogDto>> GetAllByDateRangeAsync(DateTime startDate, DateTime endDate);
        ...
        /// <returns>a <see cref="Task"/> that contains the result of the async operation</returns>
        Task<IEnumerable<AddressSearchAuditLogDto>> GetAllByResultCountRangeAsync(int startCount, int endCount);
    }
}