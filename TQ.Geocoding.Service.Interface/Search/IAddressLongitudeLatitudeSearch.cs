...
{
    public interface IAddressLongitudeLatitudeSearch
    {
        /// <summary>
        ...
        Task<IEnumerable<SimpleAddressDto>> GetAddressesByLongitudeLatitudeAsync(GetAddressByLongitudeLatitudeRequest request);
        ...
        Task<IEnumerable<SimpleWelshAddressDto>> GetWelshAddressesByLongitudeLatitudeAsync(GetAddressByLongitudeLatitudeRequest request);
    }
}